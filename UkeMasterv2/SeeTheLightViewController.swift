//
//  SeeTheLightViewController.swift
//  UkeMasterv2
//
...
class SeeTheLightViewController: UIViewController {
    ...
    func sendRequest(id: Int) {
        let ref = Firebase(url:"http://ukemaster-fe566.firebaseio.com/ISeeTheLight/" + String(id))
