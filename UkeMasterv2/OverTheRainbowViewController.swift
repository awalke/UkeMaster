//
//  OverTheRainbowViewController.swift
//  UkeMasterv2
//
//  Created by Allison Walke on 9/18/16.
...
class OverTheRainbowViewController: UIViewController {
    ...
    func sendRequest(id: Int) {
        let ref = Firebase(url:"http://ukemaster-fe566.firebaseio.com/OverTheRainbow/" + String(id))
    ...
    @IBOutlet weak var NextButtonOutlet: UILabel!
